...
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{images/top_level_block_1.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{images/top_level_block_2.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{images/top_level_block_3.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{images/top_level_block_4.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.98\textwidth]{functional_units/seven_seg_6/seven_seg_6_block.png}
...
\caption{The Simulation results of the vga\_encoder functional unit used in the final design.}
\end{figure}
\clearpage
...
\catcode`\_=13
\def_{\textunderscore}
\subsubsection{clock_modulator Component Block}
\catcode`_=8
Because a VGA operates with a clock with a frequency of 25MHz, a clock\_modulator slows down the 50MHz-clock to have a frequency of 25MHz. As shown in the simulation, the clock frequency has decreased by half.
\begin{itemize}
\item \textbf{Inputs:  } A clock\_modulator has one input, clock\_in. The clock\_in is the clock with a frequency of 50Mhz.
\item \textbf{Outputs: } A clock\_modulator has one output, clock\_out. The clock\_out is the clock that is slowed down by half.
\end{itemize}
\begin{figure}[h]
\centering
\includegraphics[width=.48\textwidth]{functional_units/vga_encoder/individual_blocks/clock_modulator_symbol.png}
\caption{The block symbol of the clock\_modulator module used in the vga\_encoder functional unit.}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{functional_units/vga_encoder/individual_blocks/clock_modulator_sim.png}
  \caption{The simulation results of the clock\_modulator individual block used in the vga\_encoder functional unit.}
    \label{fig:individual-1-2-sim}
\end{figure}
\clearpage
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{functional_units/vga_encoder/individual_blocks/vga_640x480_sim_Hsync.png}
  \caption{The simulation results of the vga\_640x480 individual block used in the vga\_encoder functional unit.}
    \label{fig:individual-1-2-sim}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{functional_units/vga_encoder/individual_blocks/vga_640x480_sim_Vsync.png}
  \caption{The simulation results of the vga\_640x480 individual block used in the vga\_encoder functional unit.}
    \label{fig:individual-1-2-sim}
\end{figure}
\clearpage
...
\begin{figure}[h]
\centering
\includegraphics[width=.48\textwidth]{functional_units/mux_1.jpg}
\caption{The block symbol of the mux2 module used in the vcr\_decoder functional unit.}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=.98\textwidth]{functional_units/mux2_sim.png}
  \caption{The simulation results of the mux2 individual block used in the vcr\_decoder functional unit.}
    \label{fig:individual-1-2-sim}
\end{figure}
\clearpage
...
\begin{figure}[h]
\centering
\includegraphics[width=.48\textwidth]{functional_units/vcr_decoder/individual_blocks/SignalDecoder_symbol.png}
\caption{The block symbol of the SignalDecoder module used in the vcr\_decoder functional unit.}
\end{figure}
\begin{figure}[h]
  \centering
...
\begin{figure}[h]
\centering
\includegraphics[width=.98\textwidth]{functional_units/parsed_clock/individual_blocks/delay_block.png}
