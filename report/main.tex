...
\subsection{seven_seg_6}
\subsubsection{Component Blocks of seven_seg_6 Unit}
\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/seven_seg_6/sv_individual_blocks/sevenseg.sv}
\subcaption{SystemVerilog code for theseven_seg_6 block used in the design.}
\end{figure}

\clearpage

\subsection{L293D_encoder}
\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/L293D_encoder/L293D_encoder.sv}
\subcaption{SystemVerilog code for theL293D_encoder block used in the design.}
\end{figure}

\clearpage

\subsection{nes_decoder}
\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/nes_decoder/nes_decoder.sv}
\subcaption{SystemVerilog code for thenes_decoder block used in the design.}
\end{figure}

\clearpage

\subsection{parsed_clock}
\subsubsection{Component Blocks of parsed_clock Unit}
\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/parsed_clock/sv_individual_blocks/parser.sv}
\subcaption{SystemVerilog code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/parsed_clock/sv_individual_blocks/comparator.sv}
\subcaption{SystemVerilog code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/parsed_clock/sv_individual_blocks/mux4.sv}
\subcaption{SystemVerilog code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/parsed_clock/sv_individual_blocks/counter.sv}
\subcaption{SystemVerilog code for theparsed_clock block used in the design.}
\end{figure}

\clearpage

\subsection{nes_to_motor}
\begin{figure}[h]
\lstinputlisting[style=verilog-style]{functional_units/nes_to_motor/nes_to_motor.sv}
\subcaption{SystemVerilog code for thenes_to_motor block used in the design.}
\end{figure}
...
\subcaption{Do Script code for theseven_seg_6 block used in the design.}
\end{figure}
...
\subsubsection{Component Blocks of seven_seg_6 Unit}
\begin{figure}[h]
\lstinputlisting[]{functional_units/seven_seg_6/do_individual_blocks/sevenseg.do}
\subcaption{Do Script code for theseven_seg_6 block used in the design.}
\end{figure}
...
\subcaption{Do Script code for theL293D_encoder block used in the design.}
\end{figure}
...
\subcaption{Do Script code for thenes_decoder block used in the design.}
\end{figure}
...
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}
...
\subsubsection{Component Blocks of parsed_clock Unit}
\begin{figure}[h]
\lstinputlisting[]{functional_units/parsed_clock/do_individual_blocks/counter.do}
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[]{functional_units/parsed_clock/do_individual_blocks/parser.do}
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[]{functional_units/parsed_clock/do_individual_blocks/enable_flip_flop.do}
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[]{functional_units/parsed_clock/do_individual_blocks/delay.do}
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[]{functional_units/parsed_clock/do_individual_blocks/mux4.do}
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}

\begin{figure}[h]
\lstinputlisting[]{functional_units/parsed_clock/do_individual_blocks/comparator.do}
\subcaption{Do Script code for theparsed_clock block used in the design.}
\end{figure}
...
\subcaption{Do Script code for thenes_to_motor block used in the design.}
\end{figure}
